...
- 🧠 **为 AI Agent 优化** —— 提供 Skill / MCP 风格接入，Agent 可直接代你订阅、检索、拉取最新文章
- 💻 **一行命令搞定** —— 配套 CLI（`mp2rss`）支持登录、订阅、列表、搜索，把订阅管理塞进终端与脚本
...
- 🛠️ [API 文档](https://areyoubugcoder.github.io/Mp2RSS/api/) —— 把订阅、检索、拉文章接进自己的服务或 AI Agent
- ⌨️ [CLI 文档](https://areyoubugcoder.github.io/Mp2RSS/cli/) —— 在终端里一行命令完成登录、订阅与管理
...
- [API 文档](https://areyoubugcoder.github.io/Mp2RSS/api/)
